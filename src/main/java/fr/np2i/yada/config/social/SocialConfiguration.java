package fr.np2i.yada.config.social;

import fr.np2i.yada.repository.SocialUserConnectionRepository;
import fr.np2i.yada.repository.CustomSocialUsersConnectionRepository;
import fr.np2i.yada.security.jwt.TokenProvider;
import fr.np2i.yada.security.social.CustomSignInAdapter;
