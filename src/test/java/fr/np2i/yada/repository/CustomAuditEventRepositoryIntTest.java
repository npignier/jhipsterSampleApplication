package fr.np2i.yada.repository;

import fr.np2i.yada.JhipsterSampleApplicationApp;
import fr.np2i.yada.config.Constants;
import fr.np2i.yada.config.audit.AuditEventConverter;
import fr.np2i.yada.domain.PersistentAuditEvent;
...
import static fr.np2i.yada.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
